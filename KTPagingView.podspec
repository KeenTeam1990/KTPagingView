#
#  Be sure to run `pod spec lint KTPagingView.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/KeenTeam1990/KTPagingView.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "KTPagingView/*.swift"
