//
//  KTPageContentCollectionView.swift
//  KTPagingViewSwiftExample
//
//  Created by KT on 2015/9/12.
//  Copyright © 2015年 KT. All rights reserved.
//

import UIKit

@objc protocol KTPageContentCollectionViewDelegate: NSObjectProtocol {
    /**
     *  联动 KTPageTitleView 的方法
     *
     *  @param pageContentCollectionView      KTPageContentCollectionView
     *  @param progress             KTPageContentCollectionView 内部视图滚动时的偏移量
     *  @param originalIndex        原始视图所在下标
     *  @param targetIndex          目标视图所在下标
     */
    @objc optional func pageContentCollectionView(pageContentCollectionView: KTPageContentCollectionView, progress: CGFloat, originalIndex: Int, targetIndex: Int)
    
    /**
     *  获取 KTPageContentCollectionView 当前子控制器的下标值
     *
     *  @param pageContentCollectionView     KTPageContentCollectionView
     *  @param index                         KTPageContentCollectionView 当前子控制器的下标值
     */
    @objc optional func pageContentCollectionView(pageContentCollectionView: KTPageContentCollectionView, index: Int)
    
    /// KTPageContentCollectionView 内容开始拖拽方法
    @objc optional func pageContentCollectionViewWillBeginDragging()
    /// KTPageContentCollectionView 内容结束拖拽方法
    @objc optional func pageContentCollectionViewDidEndDecelerating()
}

private let cellID = "cellID"

class KTPageContentCollectionView: UIView {
    /**
     *  拓展 init 方法
     *
     *  @param frame        frame
    ...
    // MARK: - 给外界提供的属性
    /// KTPageContentCollectionViewDelegate
    weak var delegateCollectionView: KTPageContentCollectionViewDelegate?
    /// KTPageContentCollectionView 是否可以滚动，默认为 true
...
// MARK: - 给外界提供的方法
extension KTPageContentCollectionView {
    /// 根据 KTPageTitleView 标题选中时的下标并显示相应的子控制器
...
extension KTPageContentCollectionView: UICollectionViewDelegate, UICollectionViewDataSource {
