...
@objc protocol KTPageContentScrollViewDelegate: NSObjectProtocol {
    /**
     *  联动 KTPageTitleView 的方法
     *
     *  @param KTPageContentScrollView      KTPageContentScrollView
     *  @param progress             KTPageContentScrollView 内部视图滚动时的偏移量
     *  @param originalIndex        原始视图所在下标
     *  @param targetIndex          目标视图所在下标
     */
    @objc optional func pageContentScrollView(pageContentScrollView: KTPageContentScrollView, progress: CGFloat, originalIndex: Int, targetIndex: Int)
     ...
     */
    @objc optional func pageContentScrollView(pageContentScrollView: KTPageContentScrollView, index: Int)

    /// KTPageContentScrollView 内容开始拖拽方法
    @objc optional func pageContentScrollViewWillBeginDragging()
    /// KTPageContentScrollView 内容结束拖拽方法
    @objc optional func pageContentScrollViewDidEndDecelerating()
}

class KTPageContentScrollView: UIView {
    /**
     *  拓展 init 方法
     *
     *  @param frame        frame
    ...
    weak var delegateScrollView: KTPageContentScrollViewDelegate?
...
// MARK: - 给外界提供的方法
extension KTPageContentScrollView {
...
extension KTPageContentScrollView: UIScrollViewDelegate {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        // 3、pageContentScrollViewDelegate; 将 progress／sourceIndex／targetIndex 传递给 KTPageTitleView
