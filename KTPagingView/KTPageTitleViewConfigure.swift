...
//  KTPagingViewSwift
//  Version 0.0.6
//  GitHub：https://github.com/KT/KTPagingView-Swift
//
//  KTPageTitleViewConfigure.swift
...
class KTPageTitleViewConfigure: NSObject {
    // MARK: - KTPageTitleView 属性
    /// KTPageTitleView 是否需要弹性效果，默认为 true
    var needBounces: Bool = true
    /// 是否显示底部分割线，默认为 true
    var showBottomSeparator: Bool = true
    /// KTPageTitleView 底部分割线颜色，默认为 lightGray
